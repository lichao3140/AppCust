...
public class ClientHelper {
    ...
    public ClientHelper(Context mContext, String url, String jsonStr,
                        Handler mHandler) {
        ...
        if (isshowProgress) {
            progressdialog = new SweetAlertDialog(mContext,
    ...
    public ClientHelper(Context mContext, String url, String jsonStr,
                        Handler mHandler, boolean isshowProgress) {
        this.mContext = mContext;
        this.url = url;
        this.params = new RequestParams("UTF-8");
        this.mHandler = mHandler;
    ...
    public ClientHelper(Context mContext, String url, RequestParams params,
                        Handler mHandler) {
        this.mContext = mContext;
        this.url = url;
        this.params = params;
    ...
    public void sendPost(boolean isHasToken) {
        ...
        myRestClient.Post((this.url + "?token=" + AppContext
...
//                                }
                    ...
                    public void onFailure(
                        ...
                        msg.what = Constants.TAG_FAIL;
                        MyLog.i(TAG,
                                "url="+this.getRequestUrl()+"http errorcode = " + arg0.getExceptionCode());
                        // progressdialog.dismiss();
                        if (isshowProgress && progressdialog != null) {
                            progressdialog.setTitleText( "请求失败!" + arg0.getExceptionCode())
                                    .setConfirmText("确认")
